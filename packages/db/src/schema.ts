...
export const onboardingModeEnum = pgEnum("onboarding_mode", ["guided", "gated"]);
export const queueKindEnum = pgEnum("queue_kind", ["mentor", "tech", "judging"]);
export const queueStatusEnum = pgEnum("queue_status", ["open", "claimed", "escalated", "closed", "canceled"]);
export const teamStatusEnum = pgEnum("team_status", ["solo", "looking", "recruiting", "full", "assigned"]);
...
export const guilds = pgTable("guilds", {
  ...
  onboardingMode: onboardingModeEnum("onboarding_mode").notNull().default("guided"),
...
export const teams = pgTable("teams", {
  ...
  desiredSkills: jsonb("desired_skills").$type<string[]>().notNull().default([]),
...
export const queueTickets = pgTable(
  ...
  (table) => ({
    guildStatusIdx: uniqueIndex("queue_ticket_guild_id_idx").on(table.guildId, table.id)
  })
);
